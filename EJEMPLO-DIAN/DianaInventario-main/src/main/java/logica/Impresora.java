...
public class Impresora {
    ...
    private void imprimirEnMacc(String zplData) {
        String filePath = System.getProperty("user.home") + "/Desktop/bebeBoste.zpl";
        String printerName = "Zebra_Technologies_ZTC_ZD230_203dpi_ZPL"; // Nombre de la cola CUPS validada en macOS
    ...
    private void imprimirEnMac(String zplData) {
        String defaultPrinterName = "Zebra_Technologies_ZTC_ZD230_203dpi_ZPL";
        ...
        try {
            // Usar archivo temporal evita problemas cuando Desktop no existe o no es accesible.
            File zplFile = File.createTempFile("bebeBoste-", ".zpl");
            zplFile.deleteOnExit();
            ...
            e.printStackTrace();
            System.err.println("Error al crear o escribir el archivo ZPL temporal en macOS: " + e.getMessage());
        }
    }

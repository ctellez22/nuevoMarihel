    ...
    public SessionContext authenticate(String username, String plainPassword) {
        ...
        try {
            Query query = em.createNativeQuery("""
                    SELECT u.id, u.username, r.nombre, COALESCE(u.punto_fisico, '')
                    FROM app_usuario u
            ...
            String puntoFisico = (String) row[3];
            ...
            return new SessionContext(userId, normalizedUsername, role, puntoFisico);
